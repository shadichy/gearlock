...
///
/// The position of the panel within an [NoGapExpansionPanelList] is given by
/// [panelIndex].
...
/// [NoGapExpansionPanelList].
///
/// See [NoGapExpansionPanelList] for a sample implementation.
///
/// See also:
///
///  * [NoGapExpansionPanelList]
...
class ExpansionPanel {
  /// Creates an expansion panel to be used as a child for [NoGapExpansionPanelList].
  /// See [NoGapExpansionPanelList] for an example on how to use this widget.
  ///
...
/// This means that at any given time, at most, one [NoGapExpansionPanelRadio]
/// can remain expanded.
///
/// A unique identifier [value] must be assigned to each panel.
/// This identifier allows the [NoGapExpansionPanelList] to determine
/// which [NoGapExpansionPanelRadio] instance should be expanded.
///
/// See [ExpansionPanelList.radio] for a sample implementation.
class NoGapExpansionPanelRadio extends ExpansionPanel {
...
/// expansions.
///
/// Note that [expansionCallback] behaves differently for [NoGapExpansionPanelList]
...
///  * <https://material.io/design/components/lists.html#types>
class NoGapExpansionPanelList extends StatefulWidget {
  /// Creates an expansion panel list widget. The [expansionCallback] is
  /// triggered when an expansion panel expand/collapse button is pushed.
  ///
  /// The [children] and [animationDuration] arguments must not be null.
  const NoGapExpansionPanelList({
    super.key,
  ...
  /// {@end-tool}
  const NoGapExpansionPanelList.radio({
    super.key,
    this.children = const <NoGapExpansionPanelRadio>[],
    this.expansionCallback,
    this.animationDuration = kThemeAnimationDuration,
  ...
  @override
  State<StatefulWidget> createState() => _NoGapExpansionPanelListState();
}

class _NoGapExpansionPanelListState extends State<NoGapExpansionPanelList> {
  NoGapExpansionPanelRadio? _currentOpenPanel;
    ...
    if (widget._allowOnlyOnePanelOpen) {
      ...
      if (widget.initialOpenPanelValue != null) {
        _currentOpenPanel = searchPanelByValue(
            widget.children.cast<NoGapExpansionPanelRadio>(),
  ...
  @override
  void didUpdateWidget(NoGapExpansionPanelList oldWidget) {
  ...
  bool _allIdentifiersUnique() {
    ...
    for (final NoGapExpansionPanelRadio child
        in widget.children.cast<NoGapExpansionPanelRadio>()) {
  ...
  bool _isChildExpanded(int index) {
    if (widget._allowOnlyOnePanelOpen) {
      final NoGapExpansionPanelRadio radioWidget =
          widget.children[index] as NoGapExpansionPanelRadio;
  ...
  void _handlePressed(bool isExpanded, int index) {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      final NoGapExpansionPanelRadio pressedChild =
          widget.children[index] as NoGapExpansionPanelRadio;
      ...
      for (int childIndex = 0;
          ...
          childIndex += 1) {
        final NoGapExpansionPanelRadio child =
            widget.children[childIndex] as NoGapExpansionPanelRadio;
  ...
  NoGapExpansionPanelRadio? searchPanelByValue(
      List<NoGapExpansionPanelRadio> panels, Object? value) {
    for (final NoGapExpansionPanelRadio panel in panels) {
